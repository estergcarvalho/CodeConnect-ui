...
function listarPostagens() {
    var postagensUsuario = $(".card-post-loading");
    postagensUsuario.fadeIn();
    postagensUsuario.LoadingOverlay("show");
    ...
    $.ajax({
        ...
        success: function(data) {
            if(data != null) {
                $('#lista-postagem').empty();

                data.forEach(function(postagem) {
                    $('#lista-postagem').prepend(
                        '<div class="card mb-3">' +
                            ...
                            '<div class="card-body">' +
                                '<p class="card-post-text">' + postagem.descricao + '</p>' +
                            '</div>' +
                            '<div class="card-footer pb-0">' +
                                '<div class="card-reactions-count">' +
                                    '<a href="#" class="card-reactions-count-likes">10 curtidas</a>' +
            ...
            var listarPostagens = $(".card-post-loading");
            listarPostagens.LoadingOverlay("hide");
        },
